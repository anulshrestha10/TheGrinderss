...
def highestscore():
    with open(logandsign_Final.Username_entry.get() + ".txt", "r") as f:
        return f.read()
...
over_text = over_font.render("Crashed! Game Over", True, (245, 66, 66))
...
def countdown():
    ...
    while countdown:
        ...
        largetext_ = largetext.render("3", True, (245, 66, 66))
        ...
        largetext = pygame.font.Font('freesansbold.ttf', 115)
        largetext_ = largetext.render("2", True, (245, 66, 66))
        screen.blit(largetext_, (360, 250))
        pygame.display.update()
        clock.tick(1)
        screen.fill((119, 119, 119))
        ...
        largetext = pygame.font.Font('freesansbold.ttf', 115)
        largetext_ = largetext.render("1", True, (245, 66, 66))
        screen.blit(largetext_, (360, 250))
        pygame.display.update()
        clock.tick(1)
        screen.fill((119, 119, 119))
    ...
    while running:
        ...
        if totalenemy_car_y >= 800:
            ...
            if int(car_passed) % 30 == 0:
                ...
                text = font1.render("Level" + ' ' + str(level), True, (1, 1, 1))
        ...
        if highestScore < score:
            highestScore = score
        with open(logandsign_Final.Username_entry.get() + ".txt", "w") as f:
            f.write(str(highestScore))

        pygame.draw.rect(screen, (245, 158, 66), (670, 0, 130, 40))
        text = pygame.font.Font('freesansbold.ttf', 15)
        textSurf, textRect = text_object('Press P to Pause', text)
        textRect.center = ((670 + 65), (0 + 20))
        screen.blit(textSurf, textRect)
