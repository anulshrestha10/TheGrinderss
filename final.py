...
icon = pygame.image.load('race_car_icon_125926.ico')
...
def entrypage_loop():
    ...
    while entry:
        ...
        user_font = font1.render("User: " + data_final.Username_entry.get(), True, (255, 255, 255))
...
def highestscore():
    with open(data_final.Username_entry.get() + ".txt", "r") as f:
        return f.read()
    ...
    while running:
        ...
        if totalenemy_car_y >= 800:
            ...
            if highestScore < score:
                highestScore = score
            with open(data_final.Username_entry.get() + ".txt", "w") as f:
